...
module.exports = async (req, res, next) => {
  try {
    const CognitiveProcessSelectionComponent = require('./interface/CognitiveProcessSelectionComponent'); // eslint-disable-line no-unused-vars

    const body = renderToStaticMarkup(
      <div>
        <CognitiveProcessSelectionComponent
